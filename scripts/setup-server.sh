...
echo "  6. sudo cp scripts/nginx.conf /etc/nginx/sites-available/nhadatgiatot24h"
echo "     sudo ln -s /etc/nginx/sites-available/nhadatgiatot24h /etc/nginx/sites-enabled/"
echo "     sudo nginx -t && sudo systemctl reload nginx"
echo "  7. (Optional SSL) sudo certbot --nginx -d nhadatgiatot24h.com -d www.nhadatgiatot24h.com"
